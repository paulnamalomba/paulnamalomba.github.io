...
Get ready as I will be giving you transcripts, from these transcripts you must then create .md files in this structure. I will give you info like this:

1. course number: course-9
2. module number: module-1
3. transcript lecture: lecture-1.txt

You will have to parse it into the following structure:
